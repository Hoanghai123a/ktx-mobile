...
- Hardened stays API validation (date format, date_out >= date_in, one active stay per worker) and normalized date parsing to return `YYYY-MM-DD` strings (timezone-safe).
